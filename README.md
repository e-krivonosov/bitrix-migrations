...
1) `composer require e-krivonosov/bitrix-migrations`

2) `cp vendor/e-krivonosov/bitrix-migrations/migrator migrator` - копируем исполняемый файл в удобное место.
